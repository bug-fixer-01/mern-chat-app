    ...
    try {
        ...
        conversation.map((convo) => {
            ...
            if (msg.senderId.toString() === req.user._id.toString()) {
                lastMessage[msg.receiverId.toString()] = { "msg": msg.messages, createdAt: msg.createdAt, fromMe: true }
            }
            else if (msg.receiverId.toString() === req.user._id.toString()) {
                lastMessage[msg.senderId.toString()] = { "msg": msg.messages, createdAt: msg.createdAt, fromMe: false }
            }
        })
...
export const editMessage = async (req, res) => {
    ...
    if (message.senderId.toString() !== userId.toString()) return res.status(403).send("Unauthorized");
    ...
    return res.status(200).json({ message: "Message not found" });w
